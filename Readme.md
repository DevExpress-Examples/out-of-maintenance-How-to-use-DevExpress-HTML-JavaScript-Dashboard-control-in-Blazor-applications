⛔ DEPRECATED. The following example demonstrates how to integrate the JavaScript DashboardControl into a Blazor application. Starting from v21.1, you can use the **Dashboard component for Blazor**. Visit the following repositories to find a version of this example:
